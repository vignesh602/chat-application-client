...
export declare class NzCascaderComponent implements OnInit, OnDestroy, ControlValueAccessor {
    ...
    private isActivedOption(option, index);
    /**
     * 设置某列的激活的菜单选项
     *
     * @param option 菜单选项
     ...
     */
    private setActiveOption(option, index, select?, loadChildren?);
    private loadChildren(option, index, success?, failure?);
    private onSelectOption(option, index);
    /** 由用户来定义点击后是否变更 */
    private isChangeOn(option, index);
    private setColumnData(options, index);
    /**
     * 鼠标点击选项
     *
     * @param option 菜单选项
    ...
    private delaySelect(option, index, doSelect);
    getSubmitValue(): any[];
    private onValueChange();
    constructor(elementRef: ElementRef, cdr: ChangeDetectorRef, nzUpdateHostClassService: NzUpdateHostClassService);
    private findOption(option, index);
    private isLoaded(index);
    private activateOnInit(index, value);
    private initOptions(index);
